...
Four arcade cabinets, each a single self-contained HTML file. No build step, no
...
| [**KUŞ**](games/kus/) | Flappy on a neon skyline. One button, and a gap that narrows every five points. | [`games/kus/index.html`](games/kus/index.html) |
